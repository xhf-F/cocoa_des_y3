...
samples.addDerived(p.omegam*p.H0/100.0,name='shapepar',label='\Omega_m h')
samples.saveAsText('VM_TMP_P1V2_0')
...
samples.addDerived(100*p.omegab,name='omegab100',label='100 \Omega_b')
samples.addDerived(p.omegam*p.H0/100.0,name='shapepar',label='\Omega_m h')
samples.saveAsText('VM_TMP_P1V2_1')
...
samples.addDerived(100*p.omegab,name='omegab100',label='100 \Omega_b')
samples.addDerived(p.omegam*p.H0/100.0,name='shapepar',label='\Omega_m h')
samples.saveAsText('VM_TMP_P1V2_2')
...
samples.addDerived(100*p.omegab,name='omegab100',label='100 \Omega_b')
samples.addDerived(p.omegam*p.H0/100.0,name='shapepar',label='\Omega_m h')
samples.saveAsText('VM_TMP_P1V2_3')

g=gplot.getSubplotPlotter(chain_dir=r'./',analysis_settings=analysissettings2,width_inch=8.5)
...
params = ['ns10', 'H0', 'omegab','ombh2','omegamh2','omegam','shapepar']
param_3d = None
...
#DELETE TMP FILES
subprocess.Popen("rm VM_TMP_P1V2_[0-9].*", shell=True, cwd=".")
