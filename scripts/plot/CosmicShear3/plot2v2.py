...
samples.saveAsText('VM_TMP_P2V2_0')
...
samples.addDerived(10*p.omegam,name='omegam10',label='10 \Omega_m')
samples.addDerived(100*p.omegab,name='omegab100',label='100 \Omega_b')
samples.saveAsText('VM_TMP_P2V2_1')
...
samples.addDerived(10*p.omegam,name='omegam10',label='10 \Omega_m')
samples.addDerived(100*p.omegab,name='omegab100',label='100 \Omega_b')
samples.saveAsText('VM_TMP_P2V2_2')
...
samples.addDerived(10*p.omegam,name='omegam10',label='10 \Omega_m')
samples.addDerived(100*p.omegab,name='omegab100',label='100 \Omega_b')
samples.saveAsText('VM_TMP_P2V2_3')
...
params = ['ns10', 'H0', 'omegab','DES_A1_1','DES_A1_2','DES_A2_1','DES_A2_2', 'DES_BTA_1']
param_3d = None
...
#DELETE TMP FILES
subprocess.Popen("rm VM_TMP_P2V2_[0-9].*", shell=True, cwd=".")
