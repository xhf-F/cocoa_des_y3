...
analysis_settings=analysissettings,width_inch=12.0)
...
param_3d = None
g.triangle_plot(['EXAMPLE_MCMC8', 'EXAMPLE_MCMC7'],parameter,
...
legend_labels=['Planck (35-900) + Roman + DES-Y3', 'Planck + Roman + DES-Y1'],legend_loc=(0.5,0.825),
imax_shaded=0)
g.export()