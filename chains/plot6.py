...
root_chains = ('EXAMPLE_MCMC2','EXAMPLE_MCMC3','EXAMPLE_MCMC28','EXAMPLE_MCMC29',)
...
param_3d = None
g.triangle_plot(['.VM_P6_TMP1','.VM_P6_TMP2','.VM_P6_TMP3', '.VM_P6_TMP4'],parameter,
...
'All + DES-Y1 (Cosmic Shear)',
'All + DES-Y3 (Cosmic Shear)'
],
