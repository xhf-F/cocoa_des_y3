...
parameter = [u'omegam',u'S8',u'H0',u'omegam_growth',u'ns',u'gamma']
chaindir=r'.'
...
root_chains = ('EXAMPLE_MCMC2', 'EXAMPLE_MCMC1', 'EXAMPLE_MCMC4', 'EXAMPLE_MCMC3')
...
g.settings.legend_fontsize = 14.00
