...
# THE COMPARISON TO SIMONS OBSERVATORY SHOWS THAT OUR PROCEDURE TO CUT LMAX ON TTTEEE 
# WORKS WELL
...
root_chains = ('EXAMPLE_MCMC16','EXAMPLE_MCMC15','EXAMPLE_MCMC18')
...
param_3d = None
g.triangle_plot(['.VM_P8v5_TMP1', '.VM_P8v5_TMP2','.VM_P8v5_TMP3'],parameter,
...
'Planck low-$\\ell_{\\mathrm{EE}}$ + SO high-$\\ell_{\\mathrm{TTTEEE}}$ (35 < $\\ell$ < 900) + SN (JLA)', 
],
