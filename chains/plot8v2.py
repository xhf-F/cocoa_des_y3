...
root_chains = ('EXAMPLE_MCMC16','EXAMPLE_MCMC13','EXAMPLE_MCMC15','EXAMPLE_MCMC9')
...
param_3d = None
g.triangle_plot(['.VM_P8v2_TMP1', '.VM_P8v2_TMP2','.VM_P8v2_TMP3', '.VM_P8v2_TMP4'],parameter,
