...
root_chains = ('EXAMPLE_MCMC37','EXAMPLE_MCMC39','EXAMPLE_MCMC38','EXAMPLE_MCMC35')
...
param_3d = None
g.triangle_plot(['.VM_P8v4_TMP1', '.VM_P8v4_TMP2','.VM_P8v4_TMP3', '.VM_P8v4_TMP4'],parameter,
...
shaded=False,
legend_labels=[
'Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (35 < $\\ell$ < 648)',
'Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (35 < $\\ell$ < 648) + DES-Y1', 
'Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (35 < $\\ell$ < 648) + SN (JLA)',
'Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (35 < $\\ell$ < 648) + SN (JLA) + DES-Y1', 
],
