...
root_chains = ('EXAMPLE_MCMC37','EXAMPLE_MCMC40','EXAMPLE_MCMC38','EXAMPLE_MCMC36')
...
param_3d = None
g.triangle_plot(['.VM_P8v3_TMP1', '.VM_P8v3_TMP2','.VM_P8v3_TMP3', '.VM_P8v3_TMP4'],parameter,
...
'Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (35 < $\\ell$ < 648) + DES-Y3', 
'Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (35 < $\\ell$ < 648) + SN (JLA)',
'Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (35 < $\\ell$ < 648) + SN (JLA) + DES-Y3', 
],
