...
root_chains = ('EXAMPLE_MCMC23', 'EXAMPLE_MCMC19','EXAMPLE_MCMC24', 'EXAMPLE_MCMC20')
...
param_3d = None
g.triangle_plot(['.VM_P9_TMP1', '.VM_P9_TMP2','.VM_P9_TMP3', '.VM_P9_TMP4'],parameter,
...
legend_labels=[
'Growth - Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (35 < $\\ell$ < 900) + SN (JLA) + DES-Y1', 
'Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (35 < $\\ell$ < 900) + SN (JLA) + DES-Y1',
'Growth - Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (35 < $\\ell$ < 900) + SN (JLA) + DES-Y3', 
