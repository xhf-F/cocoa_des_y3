...
parameter = [u'omegam',u'ns',u'H0',u'S8']
chaindir=r'.'
...
root_chains = ('EXAMPLE_MCMC4','EXAMPLE_MCMC5','EXAMPLE_MCMC8','EXAMPLE_MCMC9',)
...
samples.addDerived(p.omegam*p.H0/100.,name='gamma',label='{\Gamma}')
samples.addDerived(p.s8omegamp5/0.5477225575,name='S8',label='{S_8}')
samples.saveAsText('.VM_P2_TMP4')
# --------------------------------------------------------------------------------

#GET DIST PLOT SETUP
g=gplot.getSubplotPlotter(chain_dir=chaindir,
analysis_settings=analysissettings2,width_inch=9.4)
...
param_3d = None
g.triangle_plot(['.VM_P2_TMP1','.VM_P2_TMP2','.VM_P2_TMP3', '.VM_P2_TMP4'],parameter,
...
shaded=False,
legend_labels=[
'Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (33 < $\\ell$ < 396) + DES-Y1 (Cosmic Shear) - Emul', 
'Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (33 < $\\ell$ < 396) + DES-Y3 (Cosmic Shear) - Emul',
'Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (33 < $\\ell$ < 396) + DES-Y1 (Cosmic Shear) - Halofit', 
'Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (33 < $\\ell$ < 396) + DES-Y3 (Cosmic Shear) - Halofit',
],
legend_loc=(0.33,0.82))
