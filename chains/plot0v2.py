...
root_chains = ('EXAMPLE_MCMC20','EXAMPLE_MCMC21','EXAMPLE_MCMC18','EXAMPLE_MCMC19')
...
param_3d = None
g.triangle_plot(['.VM_P0v2_TMP1','.VM_P0v2_TMP2','.VM_P0v2_TMP3','.VM_P0v2_TMP4'],parameter,
