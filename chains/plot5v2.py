...
parameter = [u'omegam_growth',u'DES_A1_1',u'DES_A1_2',u'DES_A2_1',u'DES_A2_2',u'DES_BTA_1']
chaindir=r'.'
...
param_3d = None
g.triangle_plot(['.VM_P5v2_TMP1', '.VM_P5v2_TMP2','.VM_P5v2_TMP3', '.VM_P5v2_TMP4', 
  '.VM_P5v2_TMP5', '.VM_P5v2_TMP6'],parameter,
