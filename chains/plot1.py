...
parameter = [u'omegam',u'ns',u'H0',u'SS8',u'omegam_growth']
chaindir=r'.'
...
param_3d = None
g.triangle_plot(['.VM_P1_TMP1','.VM_P1_TMP2','.VM_P1_TMP3', '.VM_P1_TMP4'],parameter,
