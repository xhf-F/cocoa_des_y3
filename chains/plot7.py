...
parameter = [u'omegam',u'S8',u'omegam_growth',u'ns',u'gamma']
chaindir=r'.'
...
root_chains = ('EXAMPLE_MCMC6', 'EXAMPLE_MCMC14','EXAMPLE_MCMC2', 'EXAMPLE_MCMC10')
...
param_3d = None
g.triangle_plot(['.VM_P7_TMP1', '.VM_P7_TMP2','.VM_P7_TMP3', '.VM_P7_TMP4'],parameter,
...
legend_labels=[
'Growth - Planck low-$\\ell_{\\mathrm{EE}}$ + Planck high-$\\ell_{\\mathrm{TTTEEE}}$ (35 < $\\ell$ < 900) + DES-Y3', 
