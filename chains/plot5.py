...
root_chains = ('EXAMPLE_MCMC6','EXAMPLE_MCMC7','EXAMPLE_MCMC26','EXAMPLE_MCMC27',)
...
param_3d = None
g.triangle_plot(['.VM_P5_TMP1','.VM_P5_TMP2','.VM_P5_TMP3', '.VM_P5_TMP4'],parameter,
