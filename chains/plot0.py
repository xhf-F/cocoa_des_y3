...
root_chains = ('EXAMPLE_MCMC10','EXAMPLE_MCMC11','EXAMPLE_MCMC0','EXAMPLE_MCMC1')
...
param_3d = None
g.triangle_plot(['.VM_P0_TMP1','.VM_P0_TMP2','.VM_P0_TMP3','.VM_P0_TMP4'],parameter,
